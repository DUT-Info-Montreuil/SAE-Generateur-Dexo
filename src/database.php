...
class Database extends Connexion
{
    ...
    public function __construct() {
        parent::set_up_connection();
    }

    private function attributes_builder($attr) {
        $request = "SELECT ";
    ...
    private function query_builder($table, $attr, $where, $limit) 
    {
        $request;
        if ($attr == NULL)
            $request = "SELECT *";
    ...
    public function inner_join_query($table1, $on1, $table2, $on2, $attr, $where, $limit)
    {
        $request;
        if ($attr == NULL)
    ...
    public function get_categorie_table($attr=NULL, $where=NULL, $limit=NULL) {
        return self::query_builder("categorie", $attr, $where, $limit);
    }

    public function get_compte_table($attr=NULL, $where=NULL, $limit=NULL) {
        return self::query_builder("compte", $attr, $where, $limit);
    }

    public function get_exercices_table($attr=NULL, $where=NULL, $limit=NULL) {
        return self::query_builder("exercices", $attr, $where, $limit);
    }

    public function get_historique_table($attr=NULL, $where=NULL, $limit=NULL) {
        return self::query_builder("historique", $attr, $where, $limit);
    }

    public function get_photo_table($attr=NULL, $where=NULL, $limit=NULL) {
        return self::query_builder("photo", $attr, $where, $limit);
    }

    public function get_role_table($attr=NULL, $where=NULL, $limit=NULL) {
        return self::query_builder("role", $attr, $where, $limit);
    }

    public function get_templates_table($attr=NULL, $where=NULL, $limit=NULL) {
        return self::query_builder("templates", $attr, $where, $limit);
    }

    public function get_templates_exercice_table($attr=NULL, $where=NULL, $limit=NULL) {
